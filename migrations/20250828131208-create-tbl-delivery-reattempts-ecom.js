...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('tbl_delivery_reattempts_ecom', {
      id: {
      ...
      order_id: {
        ...
        // references: { model: 'tbl_ecom_orders', key: 'id' }, // optional FK
        // onUpdate: 'CASCADE',
        // onDelete: 'CASCADE'
      },
      reason: {
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('tbl_delivery_reattempts_ecom');
  }
};
